...
<template>
    <PageHeading forTable title="Roles" description="Manage system roles and permissions">
    ...
    <ConfirmationModal v-model:open="isEditConfirmOpen" title="Save changes?"
        description="Are you sure you want to update this role?" confirm-label="Yes, Save"
