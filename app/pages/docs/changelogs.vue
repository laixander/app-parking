...
const changelogs: ChangelogEntry[] = [
    {
        ...
        description: 'Initial project setup with core layout, authentication scaffolding, and base configuration.',
        changes: [
            { type: 'feature', text: 'Set up Nuxt 3 project with base layout and routing structure.' },
            { type: 'feature', text: 'Added demo authentication flow with role selection.' },
            { type: 'chore', text: 'Configured TypeScript, linting, and project documentation pages.' }
        ]
    }
]
